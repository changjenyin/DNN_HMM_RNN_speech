...
def main(argv):
    # Process I/O files
    raw_seq_file = open('/home/master/03/eric11220/Deep/final/framework/7model.txt', 'U')
    ...
    test_sentenceid = open('/tmp4/eric11220/MLDS_Final/mfcc/test_sentenceid_final.txt', 'U')
